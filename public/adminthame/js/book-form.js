            ...
            if (/^[\],:{}\s]*$/.test(image_list.replace(/\\["\\\/bfnrtu]/g, '@').replace(
                ...
                image_gallery.forEach((item, index) => {
                    html +=
                        `<div class="col-2 text-center">
                            ...
                            <span aria-hidden="true" value="${item}" class="btn btn-outline-danger btn-sm rounded-circle cancle-image">&#10006</span>
                        </div>`;
                });
                console.log(html);
                ...
                html =
                    `<div class="col-2">
                        ...
                        <span aria-hidden="true" value="${image_list}" class="btn btn-outline-danger btn-sm rounded-circle cancle-image">&#10006</span>
                    </div>`;
                $('.img-gallery').html(html);
            }
        }
