                ...
                <div class="tab-content">
                    <div id="home" class="tab-pane in active">
                        <table class="table table-hover border-right border-left border-bottom table-sm rounded" id="dataTable" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th style="width:60px">@sortablelink('id','ID')</th>
                                    <th style="width: 200px;">email</th>
                                    <th>Tên Sách</th>
                                    <th>Nội dung</th>
                                    <th style="width: 120px;" class="text-center">@sortablelink('created_at','Thời gian')</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @endif
                                        <a onclick="return confirm('Bạn chắc chắn muốn hủy bình luận này?')" href="{{route('comment.destroy',$comment->id)}}" class="fas fa-trash text-danger p-1 btn-action"></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            @endif
                                            <a onclick="return confirm('Bạn chắc chắn muốn hủy bình luận này?')" href="{{route('comment.destroy',$comment->id)}}" class="ml-2 font-weight-bold btn btn-sm btn-outline-danger btn-acction">Hủy</a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
