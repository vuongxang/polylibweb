...
<div class="card shadow mb-4">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-8 offset-2">
            <form action="{{route('postCate.update',$model->id)}}" method="post" enctype="multipart/form-data" class="mt-4 mb-4">
                @csrf
                <div class="form-group">
                    <label class="text-dark font-weight-bold" for="exampleInputName">Tên danh mục</label><br>
                    @if ($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <button type="button" class="fas fa-camera btn-outline-primary mb-2 btn-sm ml-2" data-toggle="modal" data-target="#exampleModal">
                            CHỌN ẢNH
                    </button><br>
                    @if ($errors->has('image'))
                ...
                <div class="form-group">
                    ...
                    @endif
                    <textarea type="text" class="form-control tinymce-editor" id="exampleInputDesc" rows="15" placeholder="Nhập thông tin chi tiết" name="description">{{ old('description',$model->description) }}</textarea>
