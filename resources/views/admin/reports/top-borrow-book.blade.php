            ...
            <div class="table-responsive">
                ...
                <div class="data-tabs">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a data-toggle="tab" class="nav-link active" href="#home">Top Sách mượn theo tuần<span class="badge badge-secondary rounded-circle"></span> </a></li>
                        <li class="nav-item"><a data-toggle="tab" class="nav-link" href="#menu1">Top sách mượn theo tháng
                            <span class="badge badge-secondary rounded-circle"></span></a>
                        </li>
                        <li class="nav-item"><a data-toggle="tab" class="nav-link" href="#menu2">Top sách mượn theo năm
                            <span class="badge badge-secondary rounded-circle"></span></a></li>
                    </ul>
