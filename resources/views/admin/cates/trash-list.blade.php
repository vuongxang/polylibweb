                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="{{route('cate.restore',['id' => $cate->id])}}" class="mr-2">Khôi phục</a> |
                                <a onclick="return confirm('Bạn chắc chắn xóa')" href="{{route('cate.forcedelete',['id' => $cate->id])}}" class="ml-2">Xóa</a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
