    ...
    <div class=" profile-info">
        ...
        <div class="data-tabs">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#home">Sách đang mượn</a></li>
                <li><a data-toggle="tab" href="#menu1">Sách đã trả</a></li>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('deleted.book',['id'=>$book->id])}}" onclick="return Deleted_at()" class="btn btn-danger">Trả sách</a>
                                    @else
