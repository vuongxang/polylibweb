...
<main>
    ...
    <div class="book-carouse book-carouse-mobile">
        ...
        <div class="book-carouse__body">
            @if (count($books) > 0)
<<<<<<< Updated upstream
            <div id="newestListBookMobile" class="carousel slide" data-interval="6000" data-ride="carousel">
=======
            <div id="newestListBook__mobile" class="carousel slide" data-interval="6000" data-ride="carousel">
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
            <div id="carouselExampleControlsMobile" data-interval="9000" class="carousel slide" data-ride="carousel">
=======
            <div id="carouselExampleControls__mobile" data-interval="9000" class="carousel slide" data-ride="carousel">
>>>>>>> Stashed changes
...
=======
    ...
    <div class="book-carouse book-carouse-table">
        ...
        <div class="book-carouse__body">
            @if (count($books) > 0)
            <div id="newestListBook__table" class="carousel slide" data-interval="6000" data-ride="carousel">
...
=======
        <div class="book-carouse__body">
            @if (count($mostBorrowBooks) > 0)
            <div id="carouselExampleControls__table" data-interval="9000" class="carousel slide" data-ride="carousel">
